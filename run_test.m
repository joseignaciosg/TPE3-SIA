...
params = [%10 ,50  ,10 ,0.8,0.005,0.75,1,1,1,1,0.000000000001,0,0,0,0; %probando elite
         ...
         % 30 ,20 ,30,0.8,0.005,0.75 ,2,2,2,3,0.000000000001,0,0,0,0;
          ...
          100,20 ,100,0.8,0.005,0.75,2,2,2,2,0.000000000001,0,0,0,0;
          ...
          100,20 ,100,0.5,0.005,0.75,3,3,1,3,0.000000000001,0,0,0,0;
          100,30 ,100,0.6,0.005,0.75,3,3,1,1,0.000000000001,0,0,0,0;
          100,40 ,100,0.8,0.005,0.75,3,3,1,2,0.000000000001,0,0,0,0;
          100,100,100,0.9,0.005,0.75,3,3,1,3,0.000000000001,0,0,0,0;
          100,100,100,0.9,0.05,0.75,3,3,1,3,0.000000000001,0,0,0,0; 
          100,100,100,0.9,0.005,0.75,4,4,1,3,0.000000000001,0,0,0,0; %probando torneo
          ...
          30 ,20 ,30 ,0.9,0.05,0.75,4,4,1,1,0.000000000001,0,0,0,0;
          ...
          100,20 ,100,0.5,0.005,0.75,5,5,3,1,0.000000000001,0,0,0,0;
          100,30 ,100,0.6,0.005,0.75,5,5,1,2,0.000000000001,0,0,0,0;
          100,40 ,100,0.8,0.005,0.75,5,5,1,2,0.000000000001,0,0,0,0;
          100,100,100,0.9,0.005,0.75,5,5,1,3,0.000000000001,0,0,0,0;
          20 ,20 ,20 ,0.9,0.005,0.75,1,2,1,1,0.000000000001,0,0,0,0; %probando metodo 1
          100,20 ,100,0.5,0.05,0.75,3,5,3,1,0.000000000001,0,0,0,0;
          100,30 ,100,0.6,0.005,0.75,5,2,1,1,0.000000000001,0,0,0,0;
          100,40 ,100,0.8,0.005,0.75,2,1,1,1,0.000000000001,0,0,0,0;
          100,100,100,0.9,0.005,0.75,5,3,1,1,0.000000000001,0,0,0,0;
          20 ,20 ,20 ,0.9,0.005,0.75,1,2,1,2,0.000000000001,0,0,0,0; %probando metodo 2
          100,20 ,100,0.5,0.005,0.75,3,5,3,2,0.000000000001,0,0,0,0;
          100,30 ,100,0.6,0.005,0.9,5,2,1,2,0.000000000001,0,0,0,0;
          100,40 ,100,0.8,0.005,0.75,2,1,1,2,0.000000000001,0,0,0,0;
          100,100,100,0.9,0.05,0.75,5,3,1,2,0.000000000001,0,0,0,0;
          20 ,20 ,20 ,0.9,0.005,0.75,1,2,1,3,0.000000000001,0,0,0,0; %probando metodo 3
          100,20 ,100,0.5,0.005,0.75,3,5,3,3,0.000000000001,0,0,0,0;
          100,30 ,100,0.6,0.05,0.9,5,2,1,3,0.000000000001,0,0,0,0;
          100,40 ,100,0.8,0.005,0.75,2,1,1,3,0.000000000001,0,0,0,0;
          100,100,100,0.9,0.005,0.75,5,3,1,3,0.000000000001,0,0,0,0;];
i=1;
test_counter=1;
N = size(params,1);
while (i <= N)
